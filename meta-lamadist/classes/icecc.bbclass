...
#
# Vendored into meta-lamadist from openembedded-core at ecf8c386cf^
# (the last in-tree revision; upstream dropped the class 2025-06-05
# recommending a dedicated layer).  Local changes are marked with
# "LamaDist:" comments.
#
...
# LamaDist: nativesdk-icecc-toolchain is not vendored (icecc in the
# SDK is unsupported here); empty keeps SDK builds working with the
# class inherited.
ICECC_SDK_HOST_TASK = ""
